...
JOIN proud-portfolio-458616-f7.kimia_farma.kf_kantor_cabang c ON t.branch_id = c.branch_id
JOIN proud-portfolio-458616-f7.kimia_farma.kf_product p ON t.product_id = p.product_id;